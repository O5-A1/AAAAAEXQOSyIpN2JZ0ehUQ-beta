...
SCPT_DIR="/etc/SCRIPT"
SCPresq="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL081LUExL0FBQUFBRVhRT1N5SXBOMkpaMGVoVVEtYmV0YS9tYWluL1BST1lFQ1RPU19ERVNDT05USU5VQURPUy9HRU5FUkFET1ItVlBTLU1YL2dlcmFkb3I="
SUB_DOM='base64 -d'
rm $(pwd)/$0
ofus () {
unset server
...
[[ ! -e /usr/bin/trans ]] && wget -O /usr/bin/trans https://raw.githubusercontent.com/O5-A1/AAAAAEXQOSyIpN2JZ0ehUQ-beta/main/PROYECTOS_DESCONTINUADOS/GENERADOR-VPS-MX/Install/trans &> /dev/null
