...
[[ ! -e /usr/bin/trans ]] && wget -O /usr/bin/trans https://raw.githubusercontent.com/O5-A1/AAAAAEXQOSyIpN2JZ0ehUQ-beta/main/PROYECTOS_DESCONTINUADOS/GENERADOR-VPS-MX/Install/trans?token=AVTV65MVGNVB5PUTK54HK6LBI4TJK &> /dev/null
